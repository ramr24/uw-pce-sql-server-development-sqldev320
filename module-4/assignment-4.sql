...
** 2023-05-17	Ramkumar Rajanbabu	Incomplete questions 5, 8, 10
**************************************************/
...
CREATE INDEX [SalesOrderDetail_CarrierTracking]
ON [Sales].[SalesOrderDetail]
...
-- Attempt 1: RAND() has value 0 to 1
--SELECT RAND() AS [Random Number]
--GO
-- Attempt 2: RAND() between 10 to 19
--SELECT FLOOR(RAND()*(19-10+1)+10)  AS [Random Number]
--GO
-- Attempt 3: Unsure?
USE ramr2012;
GO
DROP TABLE IF EXISTS [dbo].[RandomNumbers]
GO
DELETE FROM [dbo].[RandomNumbers]
GO
...
SELECT FLOOR(RAND()*(@Max-@Min+1)+@Min)  AS [Random Number]
GO

SELECT * FROM [dbo].[RandomNumbers]
GO
